...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { autor: @opinion.autor, cuerpo: @opinion.cuerpo, post_id: @opinion.post_id } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { autor: @opinion.autor, cuerpo: @opinion.cuerpo, post_id: @opinion.post_id } }
